...
// MARK: - 预设配置 - 24个预设（按 Proffieboard V2_2B_config.h 实际顺序）
let saberPresets: [SaberPreset] = [
    SaberPreset(name: "Shan", color: Color(red: 0/255, green: 0/255, blue: 255/255), soundFile: "", index: 0),
    SaberPreset(name: "The_ReturnV2", color: Color(red: 0/255, green: 255/255, blue: 0/255), soundFile: "", index: 1),
    SaberPreset(name: "Duke", color: Color(red: 255/255, green: 0/255, blue: 0/255), soundFile: "", index: 2),
    SaberPreset(name: "VTS", color: Color(red: 255/255, green: 255/255, blue: 0/255), soundFile: "", index: 3),
    SaberPreset(name: "CalJFO", color: Color(red: 0/255, green: 102/255, blue: 255/255), soundFile: "", index: 4),
    SaberPreset(name: "Mace", color: Color(red: 153/255, green: 0/255, blue: 255/255), soundFile: "", index: 5),
    SaberPreset(name: "The_Lost_One", color: Color(red: 0/255, green: 204/255, blue: 255/255), soundFile: "", index: 6),
    SaberPreset(name: "Halflex", color: Color(red: 30/255, green: 120/255, blue: 200/255), soundFile: "", index: 7),
    SaberPreset(name: "Krossguard_TROS", color: Color(red: 255/255, green: 0/255, blue: 0/255), soundFile: "", index: 8),
    SaberPreset(name: "Final_Steps", color: Color(red: 255/255, green: 140/255, blue: 0/255), soundFile: "", index: 9),
    SaberPreset(name: "Qui_Gon", color: Color(red: 0/255, green: 255/255, blue: 0/255), soundFile: "", index: 10),
    SaberPreset(name: "Crimson_Menace", color: Color(red: 255/255, green: 0/255, blue: 0/255), soundFile: "", index: 11),
    SaberPreset(name: "SorcererV2", color: Color(red: 255/255, green: 255/255, blue: 255/255), soundFile: "", index: 12),
